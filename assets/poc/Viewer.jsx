    ...
    <div className="flex flex-col h-screen bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-200">
      ...
      <header className="h-14 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 flex items-center justify-between px-4 shrink-0">
        ...
        <button 
          ...
          className="text-xs font-medium px-3 py-1.5 rounded-md hover:bg-slate-200 dark:hover:bg-slate-800 transition-colors"
        >
          Close File
        </button>
      </header>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Sidebar Navigation */}
        <aside className="w-72 flex flex-col border-r border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50">
