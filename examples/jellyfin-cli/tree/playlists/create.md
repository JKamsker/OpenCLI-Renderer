...
| --items | — | <IDS> | No | No | Declared | — | Comma-separated item IDs to add to the playlist | IDS · required · arity 1 |
| --json | — | flag | No | No | Declared | — | Emit JSON instead of table output | — |
| --limit | — | <N> | No | No | Declared | — | Limit result count | N · required · arity 1 |
| --name | — | <NAME> | No | No | Declared | — | Name for the new playlist | NAME · required · arity 1 |
