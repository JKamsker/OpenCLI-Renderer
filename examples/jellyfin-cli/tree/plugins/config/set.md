...
- Root: [index](../../index.md)
- Parent: [plugins config](index.md)
...
| --data | — | <JSON> | No | No | Declared | — | Inline plugin configuration JSON | JSON · required · arity 1 |
| --file | — | <FILE> | No | No | Declared | — | Read plugin configuration JSON from a file | FILE · required · arity 1 |
...
- `plugins config set 12345 --file sample.json`
