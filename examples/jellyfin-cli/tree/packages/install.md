...
| --assembly-guid | — | <GUID> | No | No | Declared | — | Assembly GUID to disambiguate package lookups | GUID · required · arity 1 |
...
| --repository-url | — | <URL> | No | No | Declared | — | Install from a specific repository URL | URL · required · arity 1 |
...
| --version | — | <VERSION> | No | No | Declared | — | Install a specific version instead of the latest | VERSION · required · arity 1 |
| --yes | — | flag | No | No | Declared | — | Skip confirmation prompts | — |

## Examples

- `packages install demo --repository-url http://localhost:8096`
