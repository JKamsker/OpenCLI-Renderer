...
| --data | — | <JSON> | No | No | Declared | — | Inline JSON with LibraryOptions | JSON · required · arity 1 |
| --file | — | <FILE> | No | No | Declared | — | JSON file with LibraryOptions | FILE · required · arity 1 |
