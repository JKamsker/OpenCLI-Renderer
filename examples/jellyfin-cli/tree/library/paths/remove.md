# `library paths remove`

- Root: [index](../../index.md)
- Parent: [library paths](index.md)
...
| --refresh | — | flag | No | No | Declared | — | Refresh the library after removing the path | — |
...
- `library paths remove folder ./sample --refresh`
