...
| --group-id | — | <ID> | No | No | Declared | — | Group ID (GUID) to join | ID · required · arity 1 |
...
- `syncplay join --group-id 00000000-0000-0000-0000-000000000001`
