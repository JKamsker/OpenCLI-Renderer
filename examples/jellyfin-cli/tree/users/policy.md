...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| --admin | — | <BOOL> | No | No | Declared | — | Set administrator status (true/false) | BOOL · required · arity 1 |
...
| --disabled | — | <BOOL> | No | No | Declared | — | Set disabled status (true/false) | BOOL · required · arity 1 |
| --hidden | — | <BOOL> | No | No | Declared | — | Set hidden status (true/false) | BOOL · required · arity 1 |
