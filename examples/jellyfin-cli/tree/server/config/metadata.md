...
| --use-file-creation-time-for-date-added | — | <VALUE> | No | No | Declared | — | Set Jellyfin's UseFileCreationTimeForDateAdded metadata option | VALUE · required · arity 1 |
