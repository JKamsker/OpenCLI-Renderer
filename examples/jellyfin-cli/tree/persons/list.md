...
| --appears-in | — | <ID> | No | No | Declared | — | Restrict results to persons connected to one item | ID · required · arity 1 |
...
| --search | — | <TERM> | No | No | Declared | — | Filter persons by name | TERM · required · arity 1 |
...
| --type | — | <TYPE> | No | No | Declared | — | Person type filter, comma-separated | TYPE · required · arity 1 |
