...
public sealed class DotnetHtmlCommand(HtmlRenderService renderService) : AsyncCommand<DotnetHtmlSettings>
{
    public override Task<int> ExecuteAsync(CommandContext context, DotnetHtmlSettings settings, CancellationToken cancellationToken)
    {
