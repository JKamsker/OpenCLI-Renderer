...
|---|---|---|---|---|---|---|
| `TN-2026-04-12-03` | `In Progress` | `2026-04-12` | Outer iteration 8 post-`g41` fresh-swarm wave 1 | Add a hosted/package validation path that proves the packed tool still carries the required StartupHook payload layout after `.nupkg` install, closing the remaining packaged-tool verification HIGH. | [2026-04-12-packaged-tool-hook-verification.md](TodoNext/2026-04-12-packaged-tool-hook-verification.md) | Complete when PR CI validates the installed `.nupkg` hook payload layout or a PR-safe installed-tool hook smoke, and the result is logged in [Logbook](Logbook.md#current-open-items-after-g41-hosted-validation-2026-04-12). |
